...
saveRDS(ResPop, file = file.path(Path_Results, "all_populations_simulated_spectra_sd075.rds"))



#apply CR

#ResPop = readRDS("../../03_RESULTS/03_Produce_POP/Reflectance/all_populations_simulated_spectra_sd075.rds")
Simulated_reflectance_data = bind_rows(ResPop$Spectralpop, .id = "column_label")
Spectral = list("Wavelength" = as.numeric(colnames(Simulated_reflectance_data[, -c(1,2)])))
...
fileName <- file.path(Path_Results,'Spectral_Simu_VNIRCR_sd075.csv')
write_csv(x = Simu_Refl_CR2,file = fileName,
          col_names = TRUE,append = FALSE)
ZipName <- paste(file_path_sans_ext(fileName),'.zip',sep = '')
zip(zipfile = ZipName,
...
saveRDS(ResPop, file = file.path(Path_Results, "all_populations_simulated_spectra_sd025.rds"))



#apply CR

#ResPop = readRDS("../../03_RESULTS/03_Produce_POP/Reflectance/all_populations_simulated_spectra_sd025.rds")
Simulated_reflectance_data = bind_rows(ResPop$Spectralpop, .id = "column_label")
Spectral = list("Wavelength" = as.numeric(colnames(Simulated_reflectance_data[, -c(1,2)])))
...
fileName <- file.path(Path_Results,'Spectral_Simu_VNIRCR_sd025.csv')
write_csv(x = Simu_Refl_CR2,file = fileName,
          col_names = TRUE,append = FALSE)
ZipName <- paste(file_path_sans_ext(fileName),'.zip',sep = '')
zip(zipfile = ZipName,
